 ...
 */
public class OfsDtFetcher implements DtFetcher {
  private static final Logger LOG =
      LoggerFactory.getLogger(OfsDtFetcher.class);

  private static final String SERVICE_NAME = OzoneConsts.OZONE_OFS_URI_SCHEME;

  private static final String FETCH_FAILED =
      "Fetch ozone delegation token failed";

  /**
   * Returns the service name for Ofs, which is also a valid URL prefix.
   */
  @Override
