 ...
 */
public class OzoneFairCallQueue<E extends Schedulable> extends AbstractQueue<E>
  ...
  private static final class MetricsProxy implements FairCallQueueMXBean,
    ...
    private MetricsProxy(String namespace) {
      ...
      MBeans.register(namespace, "OzoneFairCallQueue", this);
      final String name = namespace + ".OzoneFairCallQueue";
    ...
    public void setDelegate(OzoneFairCallQueue<? extends Schedulable> obj) {
      this.delegate
          = new WeakReference<OzoneFairCallQueue<? extends Schedulable>>(obj);
      this.revisionNumber++;
    }
