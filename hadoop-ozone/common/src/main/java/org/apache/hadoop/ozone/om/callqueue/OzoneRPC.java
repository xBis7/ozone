...
public class OzoneRPC {
  ...
  interface RpcInvoker {
     ...
     * @throws IOException
     **/
    public Writable call(OzoneRPC.Server server, String protocol,
                         Writable rpcRequest, long receiveTime) throws Exception ;
  }

  static final Logger LOG = LoggerFactory.getLogger(OzoneRPC.class);
  ...
  private OzoneRPC() {}                                  // no public ctor
  ...
  public static class Builder {
    ...
    /** Mandatory field */
    public OzoneRPC.Builder setProtocol(Class<?> protocol) {
      this.protocol = protocol;
      return this;
    }

    /** Mandatory field */
    public OzoneRPC.Builder setInstance(Object instance) {
      this.instance = instance;
      return this;
    }

    /** Default: 0.0.0.0 */
    public OzoneRPC.Builder setBindAddress(String bindAddress) {
      this.bindAddress = bindAddress;
      return this;
    }

    /** Default: 0 */
    public OzoneRPC.Builder setPort(int port) {
      this.port = port;
      return this;
    }

    /** Default: 1 */
    public OzoneRPC.Builder setNumHandlers(int numHandlers) {
      this.numHandlers = numHandlers;
      return this;
    }

    /** Default: -1 */
    public OzoneRPC.Builder setnumReaders(int numReaders) {
      this.numReaders = numReaders;
      return this;
    }

    /** Default: -1 */
    public OzoneRPC.Builder setQueueSizePerHandler(int queueSizePerHandler) {
      this.queueSizePerHandler = queueSizePerHandler;
      return this;
    }

    /** Default: false */
    public OzoneRPC.Builder setVerbose(boolean verbose) {
      this.verbose = verbose;
      return this;
    }

    /** Default: null */
    public OzoneRPC.Builder setSecretManager(
    ...
    /** Default: null */
    public OzoneRPC.Builder setPortRangeConfig(String portRangeConfig) {
      this.portRangeConfig = portRangeConfig;
      return this;
    }

    /** Default: null */
    public OzoneRPC.Builder setAlignmentContext(AlignmentContext alignmentContext) {
     ...
     */
    public OzoneRPC.Server build() throws IOException, HadoopIllegalArgumentException {
      if (this.conf == null) {
  ...
  public abstract static class Server extends org.apache.hadoop.ipc.Server {
    ...
    static class ProtoNameVer {
      ...
      public boolean equals(Object o) {
        ...
        if (this == o)
          return true;
        if (! (o instanceof OzoneRPC.Server.ProtoNameVer))
          return false;
        OzoneRPC.Server.ProtoNameVer pv = (OzoneRPC.Server.ProtoNameVer) o;
    ...
    ArrayList<Map<OzoneRPC.Server.ProtoNameVer, OzoneRPC.Server.ProtoClassProtoImpl>> protocolImplMapArray =
        new ArrayList<Map<OzoneRPC.Server.ProtoNameVer, OzoneRPC.Server.ProtoClassProtoImpl>>(OzoneRPC.RpcKind.MAX_INDEX);

    Map<OzoneRPC.Server.ProtoNameVer, OzoneRPC.Server.ProtoClassProtoImpl> getProtocolImplMap(OzoneRPC.RpcKind rpcKind) {
      if (protocolImplMapArray.size() == 0) {// initialize for all rpc kinds
        for (int i = 0; i <= OzoneRPC.RpcKind.MAX_INDEX; ++i) {
          protocolImplMapArray.add(
              new HashMap<OzoneRPC.Server.ProtoNameVer, OzoneRPC.Server.ProtoClassProtoImpl>(10));
        }
      }
    ...
    void registerProtocolAndImpl(OzoneRPC.RpcKind rpcKind, Class<?> protocolClass,
                                 Object protocolImpl) {
      String protocolName = OzoneRPC.getProtocolName(protocolClass);
      long version;


      try {
        version = OzoneRPC.getProtocolVersion(protocolClass);
      } catch (Exception ex) {
      ...
      getProtocolImplMap(rpcKind).put(new OzoneRPC.Server.ProtoNameVer(protocolName, version),
          new OzoneRPC.Server.ProtoClassProtoImpl(protocolClass, protocolImpl));
    ...
    static class VerProtocolImpl {
      final long version;
      final OzoneRPC.Server.ProtoClassProtoImpl protocolTarget;
      VerProtocolImpl(long ver, OzoneRPC.Server.ProtoClassProtoImpl protocolTarget) {
        this.version = ver;
        this.protocolTarget = protocolTarget;
      }
    }

    OzoneRPC.Server.VerProtocolImpl[] getSupportedProtocolVersions(OzoneRPC.RpcKind rpcKind,
                                                              String protocolName) {
      OzoneRPC.Server.VerProtocolImpl[] resultk =
          new OzoneRPC.Server.VerProtocolImpl[getProtocolImplMap(rpcKind).size()];
      int i = 0;
      for (Map.Entry<OzoneRPC.Server.ProtoNameVer, OzoneRPC.Server.ProtoClassProtoImpl> pv :
          getProtocolImplMap(rpcKind).entrySet()) {
        if (pv.getKey().protocol.equals(protocolName)) {
          resultk[i++] =
              new OzoneRPC.Server.VerProtocolImpl(pv.getKey().version, pv.getValue());
        }
      }
      if (i == 0) {
        return null;
      }
      OzoneRPC.Server.VerProtocolImpl[] result = new OzoneRPC.Server.VerProtocolImpl[i];
      System.arraycopy(resultk, 0, result, 0, i);
      return result;
    }

    OzoneRPC.Server.VerProtocolImpl getHighestSupportedProtocol(OzoneRPC.RpcKind rpcKind,
                                                           String protocolName) {
      Long highestVersion = 0L;
      OzoneRPC.Server.ProtoClassProtoImpl highest = null;
      if (LOG.isDebugEnabled()) {
      ...
      return new OzoneRPC.Server.VerProtocolImpl(highestVersion,  highest);
    }
    ...
    private void initProtocolMetaInfo(Configuration conf) {
      OzoneRPC.setProtocolEngine(conf, ProtocolMetaInfoPB.class,
      ...
      addProtocol(OzoneRPC.RpcKind.RPC_PROTOCOL_BUFFER, ProtocolMetaInfoPB.class,
     ...
     */
    public OzoneRPC.Server addProtocol(OzoneRPC.RpcKind rpcKind, Class<?> protocolClass,
                                  Object protocolImpl) {
    ...
    @Override
    public Writable call(OzoneRPC.RpcKind rpcKind, String protocol,
                         Writable rpcRequest, long receiveTime) throws Exception {
