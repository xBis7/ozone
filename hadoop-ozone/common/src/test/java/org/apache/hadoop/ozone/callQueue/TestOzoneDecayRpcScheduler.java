...
public class TestOzoneDecayRpcScheduler {
  ...
  public void testNegativeScheduler() {
    scheduler = new OzoneDecayRpcScheduler(-1, "", new Configuration());
  }

  @Test(expected = IllegalArgumentException.class)
  public void testZeroScheduler() {
    scheduler = new OzoneDecayRpcScheduler(0, "", new Configuration());
  }
  ...
  public void testParsePeriod() {
    ...
    assertEquals(OzoneDecayRpcScheduler
  ...
  public void testParseFactor() {
    ...
    // Custom
    Configuration conf = new Configuration();
    conf.set("ipc.4." + OzoneDecayRpcScheduler
  ...
  public void testDecay() throws Exception {
    ...
    conf.setLong("ipc.11." // Never decay
        + OzoneDecayRpcScheduler
        .IPC_SCHEDULER_DECAYSCHEDULER_PERIOD_KEY, 999999999);
    conf.setDouble("ipc.11."
        + OzoneDecayRpcScheduler.IPC_SCHEDULER_DECAYSCHEDULER_FACTOR_KEY, 0.5);
  ...
  public void testUsingWeightedTimeCostProvider() {
    ...
    ProcessingDetails callDetailsLow = mock(ProcessingDetails.class);
    when(callDetailsLow.get(ProcessingDetails.Timing.LOCKFREE))
        .thenReturn(1L);
    ProcessingDetails callDetailsMedium = mock(ProcessingDetails.class);
    when(callDetailsMedium.get(ProcessingDetails.Timing.LOCKSHARED))
        .thenReturn(500L);
    ProcessingDetails callDetailsHigh = mock(ProcessingDetails.class);
  ...
  public void testUsingWeightedTimeCostProviderWithZeroCostCalls() {
    ...
    ProcessingDetails emptyDetails = mock(ProcessingDetails.class);
  ...
  private int getPriorityIncrementCallCount(String callId) {
    ...
    ProcessingDetails emptyProcessingDetails = mock(ProcessingDetails.class);
